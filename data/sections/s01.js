  ...
  blocks: [
    ...
    /* ---------------------------------------------------- */
    {
      ...
      items: [
        ...
        { label: 'E', fr: 'E', ipa: 'ø',        kana: 'ウ',    ja: '要注意' },
        { label: 'F', fr: 'F', ipa: 'ɛf',       kana: 'エフ' },
        { label: 'G', fr: 'G', ipa: 'ʒe',       kana: 'ジェ',  ja: '要注意' },
        { label: 'H', fr: 'H', ipa: 'aʃ',       kana: 'アシュ', ja: '無音' },
        { label: 'I', fr: 'I', ipa: 'i',        kana: 'イ' },
        { label: 'J', fr: 'J', ipa: 'ʒi',       kana: 'ジ',    ja: '要注意' },
        ...
        { label: 'Q', fr: 'Q', ipa: 'ky',       kana: 'キュ',  ja: '要注意' },
        { label: 'R', fr: 'R', ipa: 'ɛʁ',       kana: 'エル',  ja: '最難関' },
        { label: 'S', fr: 'S', ipa: 'ɛs',       kana: 'エス' },
        { label: 'T', fr: 'T', ipa: 'te',       kana: 'テ' },
        { label: 'U', fr: 'U', ipa: 'y',        kana: 'ユ',    ja: '要注意' },
    ...
    /* ---------------------------------------------------- */
    {
      ...
      items: [
        { label: 'é', fr: 'café',    ja: 'アクサン・テギュ／エ' },
        { label: 'è', fr: 'père',    ja: 'アクサン・グラーヴ／開いたエ' },
        { label: 'ê', fr: 'être',    ja: 'アクサン・シルコンフレクス' },
        { label: 'ç', fr: 'français', ja: 'セディーユ／c を s の音に' },
        { label: 'ë', fr: 'Noël',    ja: 'トレマ／母音を分けて読む' },
        { label: 'à', fr: 'voilà',   ja: 'アクサン・グラーヴ' }
      ]
    },
