...
window.S2 = {
  ...
  blocks: [
...

    {
      ...
      items: [
        { label: 'français', fr: 'français', ja: 'フランス人 → française' },
        { label: 'japonais', fr: 'japonais', ja: '日本人 → japonaise' },
        { label: 'anglais', fr: 'anglais', ja: 'イギリス人 → anglaise' },
        { label: 'américain', fr: 'américain', ja: 'アメリカ人 → américaine' },
        { label: 'allemand', fr: 'allemand', ja: 'ドイツ人 → allemande' },
        { label: 'espagnol', fr: 'espagnol', ja: 'スペイン人 → espagnole' },
        { label: 'italien', fr: 'italien', ja: 'イタリア人 → italienne' },
        { label: 'chinois', fr: 'chinois', ja: '中国人 → chinoise' },
        { label: 'coréen', fr: 'coréen', ja: '韓国人 → coréenne', ipa: 'kɔʁeɛ̃' },
        { label: 'canadien', fr: 'canadien', ja: 'カナダ人 → canadienne' },
        { label: 'brésilien', fr: 'brésilien', ja: 'ブラジル人 → brésilienne', ipa: 'bʁeziljɛ̃' },
        { label: 'russe', fr: 'russe', ja: 'ロシア人（男女同形）' },
        { label: 'belge', fr: 'belge', ja: 'ベルギー人（男女同形）', ipa: 'bɛlʒ' },
        { label: 'suisse', fr: 'suisse', ja: 'スイス人（男女同形）', ipa: 'sɥis' },
        { label: 'mexicain', fr: 'mexicain', ja: 'メキシコ人 → mexicaine', ipa: 'mɛksikɛ̃' },
        { label: 'australien', fr: 'australien', ja: 'オーストラリア人 → australienne', ipa: 'ɔstʁaljɛ̃' }
      ]
    },

    {
      ...
      items: [
        { label: 'la France', fr: 'la France', ja: '女性' },
        { label: 'le Japon', fr: 'le Japon', ja: '男性' },
        { label: "l'Angleterre", fr: "l'Angleterre", ja: '女性', ipa: 'lɑ̃glətɛʁ' },
        { label: "l'Allemagne", fr: "l'Allemagne", ja: '女性', ipa: 'lalmaɲ' },
        { label: "l'Espagne", fr: "l'Espagne", ja: '女性', ipa: 'lɛspaɲ' },
        { label: "l'Italie", fr: "l'Italie", ja: '女性', ipa: 'litali' },
        { label: 'la Chine', fr: 'la Chine', ja: '女性', ipa: 'la ʃin' },
        { label: 'le Brésil', fr: 'le Brésil', ja: '男性', ipa: 'lə bʁezil' },
        { label: 'le Canada', fr: 'le Canada', ja: '男性' },
        { label: 'la Russie', fr: 'la Russie', ja: '女性', ipa: 'la ʁysi' },
        { label: 'les États-Unis', fr: 'les États-Unis', ja: '複数', ipa: 'lez etazyni' },
        { label: "l'Australie", fr: "l'Australie", ja: '女性', ipa: 'lɔstʁali' }
      ]
    },
