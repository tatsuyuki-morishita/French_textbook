...
window.S5 = {
  ...
  blocks: [
...

    {
      ...
      items: [
        { label: 'médecin', fr: 'médecin', ja: '医師（男女同形）' },
        { label: 'professeur', fr: 'professeur', ja: '教師 → professeure' },
        { label: 'étudiant', fr: 'étudiant', ja: '学生 → étudiante' },
        { label: 'avocat', fr: 'avocat', ja: '弁護士 → avocate' },
        { label: 'cuisinier', fr: 'cuisinier', ja: '料理人 → cuisinière' },
        { label: 'ingénieur', fr: 'ingénieur', ja: '技術者 → ingénieure' },
        { label: 'policier', fr: 'policier', ja: '警察官 → policière' },
        { label: 'mécanicien', fr: 'mécanicien', ja: '整備士 → mécanicienne' },
        { label: 'écrivain', fr: 'écrivain', ja: '作家 → écrivaine' },
        { label: 'artiste', fr: 'artiste', ja: '芸術家（男女同形）' },
        { label: 'musicien', fr: 'musicien', ja: '音楽家 → musicienne' },
        { label: 'photographe', fr: 'photographe', ja: '写真家（男女同形）' },
        { label: 'pilote', fr: 'pilote', ja: 'パイロット（男女同形）' },
        { label: 'infirmier', fr: 'infirmier', ja: '看護師 → infirmière' },
        { label: 'vendeur', fr: 'vendeur', ja: '販売員 → vendeuse' },
        { label: 'serveur', fr: 'serveur', ja: '給仕 → serveuse' }
      ]
    },
