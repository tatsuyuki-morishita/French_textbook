...
window.S13 = {
  ...
  blocks: [
...

    {
      ...
      title: '趣味・活動',
      items: [
        { label: 'lire', fr: 'lire', ja: '読書する' },
        { label: 'écouter de la musique', fr: 'écouter de la musique', ja: '音楽を聴く' },
        { label: 'regarder la télé', fr: 'regarder la télé', ja: 'テレビを見る' },
        { label: 'jouer aux jeux vidéo', fr: 'jouer aux jeux vidéo', ja: 'ゲームをする' },
        { label: 'jouer au football', fr: 'jouer au football', ja: 'サッカーをする' },
        { label: 'jouer au tennis', fr: 'jouer au tennis', ja: 'テニスをする' },
        { label: 'faire de la natation', fr: 'faire de la natation', ja: '水泳をする' },
        { label: 'faire du vélo', fr: 'faire du vélo', ja: '自転車に乗る' },
        { label: 'faire la cuisine', fr: 'faire la cuisine', ja: '料理をする' },
        { label: 'dessiner', fr: 'dessiner', ja: '絵を描く' },
        { label: 'faire de la photo', fr: 'faire de la photo', ja: '写真を撮る' },
        { label: 'voyager', fr: 'voyager', ja: '旅行する' },
        { label: 'faire du sport', fr: 'faire du sport', ja: '運動する' },
        { label: 'sortir avec des amis', fr: 'sortir avec des amis', ja: '友達と出かける' },
        { label: 'faire les magasins', fr: 'faire les magasins', ja: '買い物をする' },
        { label: 'se promener', fr: 'se promener', ja: '散歩する' }
      ]
    },
