...
window.S19 = {
  ...
  blocks: [
...

    {
      ...
      title: '衣類',
      items: [
        { label: 'un t-shirt', fr: 'un t-shirt', ja: 'Tシャツ', ipa: 'œ̃ tiʃœʁt' },
        { label: 'une chemise', fr: 'une chemise', ja: 'シャツ' },
        { label: 'un pantalon', fr: 'un pantalon', ja: 'ズボン' },
        { label: 'une jupe', fr: 'une jupe', ja: 'スカート' },
        { label: 'une robe', fr: 'une robe', ja: 'ワンピース' },
        { label: 'un manteau', fr: 'un manteau', ja: 'コート' },
        { label: 'une veste', fr: 'une veste', ja: 'ジャケット' },
        { label: 'un pull', fr: 'un pull', ja: 'セーター', ipa: 'œ̃ pyl' },
        { label: 'des chaussures', fr: 'des chaussures', ja: '靴' },
        { label: 'des bottes', fr: 'des bottes', ja: 'ブーツ' },
        { label: 'une écharpe', fr: 'une écharpe', ja: 'マフラー' },
        { label: 'un chapeau', fr: 'un chapeau', ja: '帽子' },
        { label: 'un sac', fr: 'un sac', ja: 'バッグ' },
        { label: 'une ceinture', fr: 'une ceinture', ja: 'ベルト' },
        { label: 'un jean', fr: 'un jean', ja: 'ジーンズ', ipa: 'œ̃ dʒin' },
        { label: 'des chaussettes', fr: 'des chaussettes', ja: '靴下' }
      ]
    },
...

    {
      ...
      items: [
        { label: 'rouge', fr: 'rouge', ja: '赤（不変）' },
        { label: 'bleu', fr: 'bleu', ja: '青 → bleue' },
        { label: 'vert', fr: 'vert', ja: '緑 → verte' },
        { label: 'jaune', fr: 'jaune', ja: '黄（不変）' },
        { label: 'noir', fr: 'noir', ja: '黒 → noire' },
        { label: 'blanc', fr: 'blanc', ja: '白 → blanche' },
        { label: 'gris', fr: 'gris', ja: '灰 → grise' },
        { label: 'rose', fr: 'rose', ja: 'ピンク（不変）' },
        { label: 'orange', fr: 'orange', ja: 'オレンジ（★不変★）' },
        { label: 'violet', fr: 'violet', ja: '紫 → violette' },
        { label: 'marron', fr: 'marron', ja: '茶（★不変★）' },
        { label: 'beige', fr: 'beige', ja: 'ベージュ（不変）' }
      ]
    },
