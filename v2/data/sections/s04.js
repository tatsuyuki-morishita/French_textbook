...
window.S4 = {
  ...
  blocks: [
...

    {
      ...
      items: [
        { label: '21', fr: 'vingt-et-un', ja: '1 のときだけ et' },
        { label: '22', fr: 'vingt-deux' },
        { label: '25', fr: 'vingt-cinq' },
        { label: '31', fr: 'trente-et-un', ja: '1 のときだけ et' },
...

    {
      ...
      title: '70 〜 100',
      items: [
        { label: '70', fr: 'soixante-dix', ja: '60+10' },
        { label: '71', fr: 'soixante-et-onze', ja: '60+11' },
        { label: '75', fr: 'soixante-quinze', ja: '60+15' },
        { label: '80', fr: 'quatre-vingts', ja: '4×20' },
        { label: '81', fr: 'quatre-vingt-un', ja: '4×20+1' },
        { label: '90', fr: 'quatre-vingt-dix', ja: '4×20+10' },
        { label: '95', fr: 'quatre-vingt-quinze', ja: '4×20+15' },
        { label: '99', fr: 'quatre-vingt-dix-neuf', ja: '4×20+10+9' },
        { label: '100', fr: 'cent' }
      ]
    },
