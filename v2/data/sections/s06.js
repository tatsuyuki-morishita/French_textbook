...
window.S6 = {
  ...
  blocks: [
...

    {
      ...
      items: [
        { label: 'parler', fr: 'parler', ja: '話す' },
        { label: 'travailler', fr: 'travailler', ja: '働く' },
        { label: 'habiter', fr: 'habiter', ja: '住む' },
        { label: 'étudier', fr: 'étudier', ja: '勉強する' },
        { label: 'aimer', fr: 'aimer', ja: '好き・愛する' },
        { label: 'écouter', fr: 'écouter', ja: '聴く' },
        { label: 'regarder', fr: 'regarder', ja: '見る' },
        { label: 'manger', fr: 'manger', ja: '食べる' },
        { label: 'danser', fr: 'danser', ja: '踊る' },
        { label: 'chanter', fr: 'chanter', ja: '歌う' },
        { label: 'jouer', fr: 'jouer', ja: '遊ぶ・演奏する' },
        { label: 'chercher', fr: 'chercher', ja: '探す' },
        { label: 'marcher', fr: 'marcher', ja: '歩く' },
        { label: 'voyager', fr: 'voyager', ja: '旅行する' },
        { label: 'acheter', fr: 'acheter', ja: '買う' },
        { label: 'donner', fr: 'donner', ja: '与える' }
      ]
    },
