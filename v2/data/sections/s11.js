...
window.S11 = {
  ...
  blocks: [

    {
      ...
      items: [
        { label: 'la mairie', fr: 'la mairie', en: '市役所' },
        { label: "l'église", fr: "l'église", en: '教会（女性）', ipa: 'legliz' },
        { label: "l'hôpital", fr: "l'hôpital", en: '病院（男性）' },
        { label: "l'école", fr: "l'école", en: '学校（女性）' },
        { label: 'la bibliothèque', fr: 'la bibliothèque', en: '図書館', ipa: 'la biblijɔtɛk' },
        { label: 'le supermarché', fr: 'le supermarché', en: 'スーパー' },
        { label: 'la boulangerie', fr: 'la boulangerie', en: 'パン屋', ipa: 'la bulɑ̃ʒʁi' },
        { label: 'la pharmacie', fr: 'la pharmacie', en: '薬局', ipa: 'la faʁmasi' },
        { label: 'la banque', fr: 'la banque', en: '銀行' },
        { label: 'la poste', fr: 'la poste', en: '郵便局' },
        { label: 'la gare', fr: 'la gare', en: '駅' },
        { label: 'le parc', fr: 'le parc', en: '公園' },
        { label: 'le cinéma', fr: 'le cinéma', en: '映画館' },
        { label: "l'hôtel", fr: "l'hôtel", en: 'ホテル（男性）' },
        { label: 'le restaurant', fr: 'le restaurant', en: 'レストラン' },
        { label: 'le marché', fr: 'le marché', en: '市場' }
      ]
    },
