...
window.S14 = {
  ...
  blocks: [

    {
      ...
      title: 'ホテルの語彙',
      items: [
        { label: "l'hôtel", fr: "l'hôtel", ja: 'ホテル' },
        { label: 'une chambre', fr: 'une chambre', ja: '部屋' },
        { label: 'chambre simple', fr: 'une chambre simple', ja: 'シングル' },
        { label: 'chambre double', fr: 'une chambre double', ja: 'ダブル' },
        { label: 'la clé', fr: 'la clé', ja: '鍵' },
        { label: 'la réception', fr: 'la réception', ja: 'フロント' },
        { label: 'le petit-déjeuner', fr: 'le petit-déjeuner', ja: '朝食' },
        { label: 'le wifi', fr: 'le wifi', ja: 'Wi-Fi' },
        { label: 'le parking', fr: 'le parking', ja: '駐車場' },
        { label: 'la salle de bains', fr: 'la salle de bains', ja: '浴室' },
        { label: 'la douche', fr: 'la douche', ja: 'シャワー' },
        { label: "l'ascenseur", fr: "l'ascenseur", ja: 'エレベーター', ipa: 'lasɑ̃sœʁ' },
        { label: 'la climatisation', fr: 'la climatisation', ja: '冷房', ipa: 'la klimatizasjɔ̃' },
        { label: 'une nuit', fr: 'une nuit', ja: '1泊' },
        { label: 'la vue', fr: 'la vue', ja: '眺め' },
        { label: 'les draps', fr: 'les draps', ja: 'シーツ', ipa: 'le dʁa' }
      ]
    },
