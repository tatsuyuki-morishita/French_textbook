...
window.S18 = {
  ...
  blocks: [
...

    {
      ...
      title: '外見の語彙',
      items: [
        { label: 'grand', fr: 'grand', en: '背が高い → grande' },
        { label: 'petit', fr: 'petit', en: '背が低い → petite' },
        { label: 'mince', fr: 'mince', en: '細身（男女同形）' },
        { label: 'gros', fr: 'gros', en: '太った → grosse' },
        { label: 'blond', fr: 'blond', en: '金髪 → blonde' },
        { label: 'brun', fr: 'brun', en: '茶髪 → brune' },
        { label: 'roux', fr: 'roux', en: '赤毛 → rousse' },
        { label: 'les cheveux', fr: 'les cheveux', en: '髪（常に複数）' },
        { label: 'les yeux', fr: 'les yeux', en: '目（œil の複数）' },
        { label: 'une barbe', fr: 'une barbe', en: 'あごひげ' },
        { label: 'une moustache', fr: 'une moustache', en: '口ひげ' },
        { label: 'des lunettes', fr: 'des lunettes', en: '眼鏡（常に複数）' },
        { label: 'court', fr: 'court', en: '短い → courte' },
        { label: 'long', fr: 'long', en: '長い → longue' },
        { label: 'frisé', fr: 'frisé', en: 'カールした' },
        { label: 'chauve', fr: 'chauve', en: 'はげた（男女同形）' }
      ]
    },

    {
      ...
      items: [
        { label: 'gentil', fr: 'gentil', en: '優しい → gentille' },
        { label: 'sympa', fr: 'sympa', en: '感じがいい（男女同形）' },
        { label: 'timide', fr: 'timide', en: '内気（男女同形）' },
        { label: 'bavard', fr: 'bavard', en: 'おしゃべり → bavarde' },
        { label: 'drôle', fr: 'drôle', en: '面白い（男女同形）' },
        { label: 'intelligent', fr: 'intelligent', en: '賢い → intelligente' },
        { label: 'courageux', fr: 'courageux', en: '勇敢 → courageuse' },
        { label: 'calme', fr: 'calme', en: '穏やか（男女同形）' },
        { label: 'dynamique', fr: 'dynamique', en: '活発（男女同形）' },
        { label: 'généreux', fr: 'généreux', en: '寛大 → généreuse' },
        { label: 'têtu', fr: 'têtu', en: '頑固 → têtue' },
        { label: 'paresseux', fr: 'paresseux', en: '怠け者 → paresseuse' },
        { label: 'sérieux', fr: 'sérieux', en: '真面目 → sérieuse' },
        { label: 'patient', fr: 'patient', en: '忍耐強い → patiente' },
        { label: 'ouvert', fr: 'ouvert', en: '開放的 → ouverte' },
        { label: 'travailleur', fr: 'travailleur', en: '働き者 → travailleuse' }
      ]
    },
