...
window.S22 = {
  ...
  blocks: [
...

    {
      ...
      title: '休暇の語彙',
      items: [
        { label: 'la plage', fr: 'la plage', ja: 'ビーチ' },
        { label: 'la montagne', fr: 'la montagne', ja: '山' },
        { label: 'la mer', fr: 'la mer', ja: '海' },
        { label: 'la campagne', fr: 'la campagne', ja: '田舎' },
        { label: 'le camping', fr: 'le camping', ja: 'キャンプ' },
        { label: 'le château', fr: 'le château', ja: '城' },
        { label: 'une île', fr: 'une île', ja: '島', ipa: 'yn il' },
        { label: 'un voyage', fr: 'un voyage', ja: '旅行' },
        { label: 'la valise', fr: 'la valise', ja: 'スーツケース' },
        { label: 'le passeport', fr: 'le passeport', ja: 'パスポート' },
        { label: 'le billet', fr: 'le billet', ja: '切符' },
        { label: 'un appareil photo', fr: 'un appareil photo', ja: 'カメラ' },
        { label: 'faire de la randonnée', fr: 'faire de la randonnée', ja: 'ハイキングをする' },
        { label: 'prendre des photos', fr: 'prendre des photos', ja: '写真を撮る' },
        { label: 'se baigner', fr: 'se baigner', ja: '泳ぐ・水浴びする' },
        { label: 'se reposer', fr: 'se reposer', ja: '休む' }
      ]
    },
