...
window.S23 = {
  ...
  blocks: [

    {
      ...
      title: '体の部位（le corps）',
      items: [
        { label: 'la tête', fr: 'la tête', en: '頭' },
        { label: 'les yeux', fr: 'les yeux', en: '目' },
        { label: 'les oreilles', fr: 'les oreilles', en: '耳' },
        { label: 'le nez', fr: 'le nez', en: '鼻' },
        { label: 'la bouche', fr: 'la bouche', en: '口' },
        { label: 'les dents', fr: 'les dents', en: '歯' },
        { label: 'la gorge', fr: 'la gorge', en: 'のど' },
        { label: 'le cou', fr: 'le cou', en: '首' },
        { label: 'le bras', fr: 'le bras', en: '腕' },
        { label: 'la main', fr: 'la main', en: '手' },
        { label: 'le dos', fr: 'le dos', en: '背中' },
        { label: 'le ventre', fr: 'le ventre', en: 'お腹' },
        { label: 'la jambe', fr: 'la jambe', en: '脚' },
        { label: 'le pied', fr: 'le pied', en: '足' },
        { label: 'le cœur', fr: 'le cœur', en: '心臓' },
        { label: 'la peau', fr: 'la peau', en: '肌' }
      ]
    },
