...
window.S29 = {
  ...
  blocks: [
...

    {
      ...
      title: '文をつなぐ語',
      items: [
        { label: 'et', fr: 'et', ja: 'そして' },
        { label: 'ou', fr: 'ou', ja: 'または' },
        { label: 'mais', fr: 'mais', ja: 'しかし' },
        { label: 'parce que', fr: 'parce que', ja: 'なぜなら' },
        { label: 'car', fr: 'car', ja: 'というのは（書き言葉）' },
        { label: 'donc', fr: 'donc', ja: 'だから' },
        { label: 'alors', fr: 'alors', ja: 'それで' },
        { label: 'puis', fr: 'puis', ja: 'それから' },
        { label: 'ensuite', fr: 'ensuite', ja: '次に' },
        { label: 'quand', fr: 'quand', ja: '〜のとき' },
        { label: 'si', fr: 'si', ja: 'もし' },
        { label: 'pendant que', fr: 'pendant que', ja: '〜する間' },
        { label: 'même si', fr: 'même si', ja: 'たとえ〜でも' },
        { label: 'pourtant', fr: 'pourtant', ja: 'それなのに' },
        { label: "d'abord", fr: "d'abord", ja: 'まず' },
        { label: 'enfin', fr: 'enfin', ja: '最後に' }
      ]
    },
